...
class NSI:
    ...
    def query(self, rid):
        summary_text = self.nsi.query(rid)
        return convert_summary2dict(summary_text)
    
        
def convert_summary2dict(text):
    status = {}
...
if __name__ == "__main__":
    ...
    pNSA = 'urn:ogf:network:pionier.net.pl:2013:nsa'
    pURI='https://banana.man.poznan.pl:8091/nsi/ConnectionProvider'

    rNSA = 'urn:ogf:network:pionier.net.pl:2013:nsa'
    rURI = 'https://150.254.160.153:29081/nsi2_requester/services/ConnectionRequester'
